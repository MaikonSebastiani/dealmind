  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">{t("deal.title.new")}</h1>
          <p className="text-muted-foreground">{t("deal.subtitle.new")}</p>
        </div>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        >
          ...
          <div className="flex gap-4">
            ...
            >
              {isSubmitting ? t("common.creating") : t("deal.action.create")}
            </Button>
          </div>
        </form>
